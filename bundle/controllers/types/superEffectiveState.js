...
module.exports = {
    superEffective() {
        console.log("superEffectiveState: superEffective");
      ...
      //Alexa list
            if(this.$alexaSkill){
                ...
                type2  =this.$inputs.typeTwo.key != undefined ? this.$inputs.typeTwo.key: "";
            } else {
    ...
    YesIntent() {
        console.log("superEffectiveState: YesIntent");
    ...
    RepeatIntent() {
        console.log("superEffectiveState: RepeatIntent");
        this.toStateIntent("superEffectiveState", "superEffective");

    },

    NoIntent() {
        console.log("superEffectiveState: NoIntent");
